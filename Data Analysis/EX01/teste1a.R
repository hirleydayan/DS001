...
notas.pesos <- notas[,c("p1", "p2", "p3", "p4")]
notas.pesos[notas.pesos < 2.5] <- 2
notas.pesos[notas.pesos >= 2.5 & notas.pesos < 5] <- 1.5
notas.pesos[notas.pesos >= 5] <- 1
medpond <- rowSums(notas[,c("p1", "p2", "p3", "p4")] * notas.pesos) / rowSums(notas.pesos)
medpond <- round(medpond, digits = 2)
medpond
...
notas.temp <- notas
notas.temp$medpond <- medpond
notasrank <- notas.temp[order(-notas.temp$medpond),]["ids"]
notasrank
